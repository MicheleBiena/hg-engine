...
struct OVERWORLD_TAG gOWTagToFileNum[] = // skip down a bit to see the parts that are specifically for pokémon
    {
        ...
        MON_FOLLOWER_ENTRY(SPECIES_TERRATOPS, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_IGNISOAR, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_DIPPLASH, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_SINFAE, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_KECLEON_ALT, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_MEOWSTIC_SHADOW, OVERWORLD_SIZE_SMALL)
