...
8. `data/IconPaletteTable.c`: add icon palette.
9. `data/SpriteOffsets.c`: add offsets.
10. `data/learnsets/learnsets.json`: only if the form does not inherit correctly
