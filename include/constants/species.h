...
#define SPECIES_TERRATOPS (MAX_CANONICAL_MON_NUM + 1) // 1076
#define SPECIES_IGNISOAR (MAX_CANONICAL_MON_NUM + 2)
#define SPECIES_DIPPLASH (MAX_CANONICAL_MON_NUM + 3)
#define SPECIES_SINFAE (MAX_CANONICAL_MON_NUM + 4)

#define NUM_OF_FAKEMONS 4

#define MAX_MON_NUM (SPECIES_PECHARUNT + NUM_OF_FAKEMONS)

// mega
#define SPECIES_MEGA_START (MAX_MON_NUM + 1) // 1080
...
// paldea
#define SPECIES_PALDEAN_FORMS_START (MAX_SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_NUM + 1) // 1358
...
#define SPECIES_GIGANTAMAX_FORMS_START (MAX_SPECIES_PALDEAN_FORM_NUM + 1) // 1397
...
#define SPECIES_PLZA_MEGAS_START (MAX_SPECIES_GIGANTAMAX_FORMS_NUM + 1) // 1431
...
// define your fakemon forms below like this
#define SPECIES_SINFAE_SHADOW (MAX_SPECIES_CANONICAL_FORM_NUM + 1)
#define SPECIES_KECLEON_ALT (MAX_SPECIES_CANONICAL_FORM_NUM + 2)
#define SPECIES_MEOWSTIC_SHADOW (MAX_SPECIES_CANONICAL_FORM_NUM + 3)

#define NUM_OF_FAKEMONS_FORM 3

#define MAX_SPECIES_INCLUDING_FORMS (MAX_SPECIES_CANONICAL_FORM_NUM + NUM_OF_FAKEMONS_FORM) // 1482
