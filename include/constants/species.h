...
#define MAX_SPECIES_CANONICAL_FORM_NUM (MAX_SPECIES_PALDEAN_FORM_NUM)
...
#define MAX_SPECIES_INCLUDING_FORMS (MAX_SPECIES_CANONICAL_FORM_NUM + NUM_OF_FAKEMONS_FORM)  // 1393
